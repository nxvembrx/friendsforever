...
class BookmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookmark" do
    assert_difference("Bookmark.count") do
      post bookmarks_url, params: { bookmark: { memo_id: @bookmark.memo_id, user_id: @bookmark.user_id } }
    end
  ...
  test "should update bookmark" do
    patch bookmark_url(@bookmark), params: { bookmark: { memo_id: @bookmark.memo_id, user_id: @bookmark.user_id } }
